'''
    머신러닝 (Machine Learning) : 숫자
    딥러닝 (Deep Learning) : 이미지
'''
# 생선 분류 문제
...
predictvalue1 = kn.predict([[30, 300]])
print('예측값 =', predictvalue1)
predictvalue2 = kn.predict([[12, 12]])
print('예측값 =', predictvalue2)

plt.scatter(30, 300, marker='^')
plt.scatter(12, 12, marker='*')
plt.savefig('a.png')
plt.show()
